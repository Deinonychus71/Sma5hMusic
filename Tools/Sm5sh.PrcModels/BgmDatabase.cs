...
{
    public class BgmDatabase : IPrcParsable
    {
        [PrcHexMapping("db_root")]
        public List<BgmDbRootEntry> DbRootEntries { get; set; }

        [PrcHexMapping("stage_bgm")]
        public List<BgmStageBgmEntry> StageBgmEntries { get; set; }

        [PrcHexMapping("stream_set")]
        public List<BgmStreamSetEntry> StreamSetEntries { get; set; }

        [PrcHexMapping("assigned_info")]
        public List<BgmAssignedInfoEntry> AssignedInfoEntries { get; set; }

        [PrcHexMapping("stream_property")]
        public List<BgmStreamPropertyEntry> StreamPropertyEntries { get; set; }

        [PrcHexMapping("fighter_jingle")]
        public List<BgmFighterJingleBgmEntry> FighterJingleEntries { get; set; }

        [PrcFilterMatch("^(bgm)")]
        public List<PcrFilterStruct<BgmPlaylistEntry>> PlaylistEntries { get; set; }
    }
    ...
    public class BgmFighterJingleBgmEntry
    {
